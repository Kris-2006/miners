...
static void ui_print_msg(ui_t *ui, chat_entry_t *msg) {
  ...
  case CHAT_TEXT:
    wattron(ui->chat_win,
            A_BOLD |
                COLOR_PAIR(strcmp(ui->username, msg->sender) == 0 ? CP_SELF
                                                                  : CP_OTHER));
